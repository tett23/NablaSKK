...
swiftc -import-objc-header crates/nablaskk-ffi/include/nablaskk.h \
    swift/SKKSession.swift macos/Shared/DictionaryConfig.swift macos/Shared/UserDictionaryModel.swift macos/Shared/InputSettings.swift macos/Sources/KeyTranslator.swift macos/Sources/ClientQuirks.swift macos/Tests/main.swift \
