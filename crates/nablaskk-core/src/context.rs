...
//   src/engine/session/SKKInputContext.h
//   src/engine/session/SKKOutputBuffer.{h,cpp}
//   src/engine/session/SKKRegistration.h
//   src/engine/session/SKKUndoContext.{h,cpp}
